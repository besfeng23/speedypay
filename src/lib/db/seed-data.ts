...
export const seedEntities: Entity[] = [
    ...
    // Level 3: A Client Merchant of the Tenant
    {
        ...
        status: 'active',
        metadata: { contactName: 'Alice Johnson', email: 'alice@example-client.com', mobile: '555-0101', propertyAssociations: ['Starlight Apartments', 'Azure Condominiums'] },
        createdAt: formatISO(subDays(now, 45)),
        updatedAt: formatISO(subDays(now, 2)),
    },
    // Level 3: Another Client Merchant
    {
        id: 'ent-collo-client-2',
        legalName: 'Second Wave Properties Inc.',
        displayName: 'Second Wave Props',
        entityType: 'merchant',
        parentEntityId: 'ent-collo',
        status: 'inactive',
        metadata: { contactName: 'Bob Williams', email: 'bob@swprops.com', mobile: '555-0102', propertyAssociations: ['Oceanview Residences'] },
...
export const seedMerchantAccounts: MerchantAccount[] = [
  ...
  {
    id: 'mer-collo-client-2',
    tenantId: 'tnt-collo',
    entityId: 'ent-collo-client-2',
    onboardingStatus: 'pending',
    kycStatus: 'pending',
    riskStatus: 'not_assessed',
    activationStatus: 'inactive',
    settlementStatus: 'paused',
    defaultSettlementDestinationId: 'sd-collo-client-2',
    createdAt: formatISO(subDays(now, 10)),
    updatedAt: formatISO(subDays(now, 1)),

    // New fields for production readiness
    merchantOfRecordType: 'client_merchant',
    providerMerchantMode: 'direct_merchant',
    settlementMode: 'provider_direct_settlement',
    settlementSchedule: 't1',
    providerMerchantId: 'prov_mer_12345',
    providerSubMerchantId: null,
    isProviderOnboarded: false,
...
export const seedSettlementDestinations: SettlementDestination[] = [
    ...
    {
        id: 'sd-collo-client-2',
        merchantAccountId: 'mer-collo-client-2',
...
export const seedSettlements: Settlement[] = [
  {
    ...
    eligibilityAt: formatISO(subHours(now, 1)),
    remittedAt: null,
    failedAt: null,
